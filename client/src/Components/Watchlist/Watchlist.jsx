  ...
  return (
    <>
      <motion.div
        ...
        className={`w-full md:w-80 p-4 sm:p-6 flex flex-col rounded-xl shadow-lg transition-colors duration-300 relative z-0 ${
          darkMode ? "bg-gray-800 text-white" : "bg-[#2D5F8B] text-white"
        }`}
      >
        {/* Top Navigation */}
        <div className="flex flex-row items-center justify-start flex-shrink-0 relative z-10">
          ...
          >
            <AddWatchlistModal onWatchlistAdded={fetchWatchlists} />
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="w-full mt-4 sm:mt-6 flex-shrink-0 relative z-20"
        >
        ...
        <motion.div
          ...
          className="w-full mt-4 sm:mt-6 flex-1 relative z-10"
        >
