          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <button
                ...
                className={`w-12 h-6 rounded-full p-1 ${isInPrice ? 'bg-blue-600' : 'bg-gray-600'
                  }`}
              >
                <div
                  className={`w-4 h-4 bg-white rounded-full transform ${isInPrice ? 'translate-x-6' : 'translate-x-0'
                    }`}
                />
              </button>
              <span>In Price</span>
